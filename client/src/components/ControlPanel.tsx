        ...
        {isOpen && (
          ...
          >
                  ...
                  return (
                    <div key={item.id} className="p-3 bg-white/5 border border-white/10 rounded-lg">
                      ...
                      >
                        ...
                        {isUp ? 'Uploading…' : isDone ? '✓ Updated!' : hasCustom ? `Replace ${item.type === 'video' ? 'Video' : 'Image'}` : `Upload ${item.type === 'video' ? 'Video' : 'Image'}`}
                      </button>
            ...
            <p className="text-center text-[10px] text-white/20 mt-2">
              Files are saved permanently in your browser
            </p>
          </motion.div>
        )}
      </AnimatePresence>
